...
CV_PY_FROM_ENUM(dnn_DataLayout)
CV_PY_TO_ENUM(dnn_DataLayout)
...
typedef cv::htpa::SensorType htpa_SensorType;
CV_PY_FROM_ENUM(htpa_SensorType)
CV_PY_TO_ENUM(htpa_SensorType)
