...
CVPY_TYPE(ClassifierEngine, htpa_ClassifierEngine, Ptr<cv::htpa::ClassifierEngine>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(ClassEngLinSVM, htpa_ClassEngLinSVM, Ptr<cv::htpa::ClassEngLinSVM>, Ptr, htpa_ClassifierEngine, 0, ".htpa")
CVPY_TYPE(df_row, htpa_df_row, cv::htpa::df_row, df_row, NoBase, 0, ".htpa")
CVPY_TYPE(DataFrame, htpa_DataFrame, cv::htpa::DataFrame, DataFrame, NoBase, pyopencv_cv_htpa_htpa_DataFrame_DataFrame, ".htpa")
CVPY_TYPE(Detector, htpa_Detector, Ptr<cv::htpa::Detector>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(SubDetector, htpa_SubDetector, Ptr<cv::htpa::SubDetector>, Ptr, htpa_Detector, 0, ".htpa")
CVPY_TYPE(TwoScaleDetector, htpa_TwoScaleDetector, Ptr<cv::htpa::TwoScaleDetector>, Ptr, htpa_Detector, 0, ".htpa")
CVPY_TYPE(OneScaleDetector, htpa_OneScaleDetector, Ptr<cv::htpa::OneScaleDetector>, Ptr, htpa_TwoScaleDetector, 0, ".htpa")
CVPY_TYPE(FeatureEngine, htpa_FeatureEngine, Ptr<cv::htpa::FeatureEngine>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(StatisticFeatEng, htpa_StatisticFeatEng, Ptr<cv::htpa::StatisticFeatEng>, Ptr, htpa_FeatureEngine, 0, ".htpa")
CVPY_TYPE(FeatEngHOG, htpa_FeatEngHOG, Ptr<cv::htpa::FeatEngHOG>, Ptr, htpa_FeatureEngine, 0, ".htpa")
CVPY_TYPE(FeatEngHOGdK, htpa_FeatEngHOGdK, Ptr<cv::htpa::FeatEngHOGdK>, Ptr, htpa_FeatEngHOG, 0, ".htpa")
CVPY_TYPE(Filter, htpa_Filter, Ptr<cv::htpa::Filter>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(AWA_Filter, htpa_AWA_Filter, Ptr<cv::htpa::AWA_Filter>, Ptr, htpa_Filter, 0, ".htpa")
CVPY_TYPE(HTPAFileReader, htpa_HTPAFileReader, Ptr<cv::htpa::HTPAFileReader>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(PostprocEngine, htpa_PostprocEngine, Ptr<cv::htpa::PostprocEngine>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(PostprocEng_NMS, htpa_PostprocEng_NMS, Ptr<cv::htpa::PostprocEng_NMS>, Ptr, htpa_PostprocEngine, pyopencv_cv_htpa_htpa_PostprocEng_NMS_PostprocEng_NMS, ".htpa")
CVPY_TYPE(PreprocEngine, htpa_PreprocEngine, Ptr<cv::htpa::PreprocEngine>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(PreprocEngAWA, htpa_PreprocEngAWA, Ptr<cv::htpa::PreprocEngAWA>, Ptr, htpa_PreprocEngine, 0, ".htpa")
CVPY_TYPE(ProposalGenerator, htpa_ProposalGenerator, Ptr<cv::htpa::ProposalGenerator>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(PropGenWatershed_v1, htpa_PropGenWatershed_v1, Ptr<cv::htpa::PropGenWatershed_v1>, Ptr, htpa_ProposalGenerator, 0, ".htpa")
CVPY_TYPE(htpa_file, htpa_htpa_file, cv::htpa::htpa_file, htpa_file, NoBase, 0, ".htpa")
CVPY_TYPE(TPArray, htpa_TPArray, Ptr<cv::htpa::TPArray>, Ptr, NoBase, pyopencv_cv_htpa_htpa_TPArray_TPArray, ".htpa")
CVPY_TYPE(Thresholder, htpa_Thresholder, Ptr<cv::htpa::Thresholder>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(HSOtsuThresh, htpa_HSOtsuThresh, Ptr<cv::htpa::HSOtsuThresh>, Ptr, htpa_Thresholder, 0, ".htpa")
CVPY_TYPE(HSMultiOtsu, htpa_HSMultiOtsu, Ptr<cv::htpa::HSMultiOtsu>, Ptr, htpa_HSOtsuThresh, 0, ".htpa")
CVPY_TYPE(Tracker, htpa_Tracker, Ptr<cv::htpa::Tracker>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(block, htpa_block, cv::htpa::block, block, NoBase, 0, ".htpa")
CVPY_TYPE(target_model, htpa_target_model, cv::htpa::target_model, target_model, NoBase, 0, ".htpa")
CVPY_TYPE(BlockTracker, htpa_BlockTracker, Ptr<cv::htpa::BlockTracker>, Ptr, htpa_Tracker, pyopencv_cv_htpa_htpa_BlockTracker_BlockTracker, ".htpa")
CVPY_TYPE(Tracktor, htpa_Tracktor, Ptr<cv::htpa::Tracktor>, Ptr, NoBase, 0, ".htpa")
CVPY_TYPE(DummyTracktor, htpa_DummyTracktor, Ptr<cv::htpa::DummyTracktor>, Ptr, htpa_Tracktor, pyopencv_cv_htpa_htpa_DummyTracktor_DummyTracktor, ".htpa")
CVPY_TYPE(BlockTracktor, htpa_BlockTracktor, Ptr<cv::htpa::BlockTracktor>, Ptr, htpa_Tracktor, pyopencv_cv_htpa_htpa_BlockTracktor_BlockTracktor, ".htpa")
